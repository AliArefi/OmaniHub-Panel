...
interface CreateStoreContextType {
    ...
    addScheduleToAssignment: (assignmentId: number, schedule: WorkScheduleEntry) => void;
    removeScheduleFromAssignment: (assignmentId: number, scheduleId: number) => void;
}
...
export const useCreateStore = () => {
    ...
    if (!ctx) throw new Error("useCreateStore must be inside CreateStoreProvider");
    return ctx;
};
...
export const CreateStoreProvider = ({ children }: { children: ReactNode }) => {
    ...
    const removeService = (id: number) => {
        ...
        // حذف تمام assignment های مرتبط با این سرویس
    ...
    const removeTeamMember = (id: number) => {
        ...
        // حذف تمام assignment های مرتبط با این عضو
    ...
    const addScheduleToAssignment = (assignmentId: number, schedule: WorkScheduleEntry) => {
        setAssignments((prev) =>
            prev.map((a) =>
                a.id === assignmentId
    ...
    const removeScheduleFromAssignment = (assignmentId: number, scheduleId: number) => {
        setAssignments((prev) =>
            prev.map((a) =>
                a.id === assignmentId
